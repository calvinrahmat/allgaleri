        ...
        <div className="relative">
          ...
          <div className="hidden lg:flex justify-between items-start relative">
            ...
            <div className="absolute" style={{ top: '3.5rem', left: '6rem', right: '6rem', height: '0.5rem' }}>
              <div className="w-full border-t-2 border-dotted border-white z-0"></div>
            </div>
            {/* Step 1 */}
            <div className="flex flex-col items-center flex-1 relative z-10 max-w-48">
              <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative" style={{ minHeight: '7rem' }}>
                <span className="absolute -top-2 -left-2 w-8 h-8 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-lg border-2 border-[#778873] shadow">1</span>
                <img src="/ICON_HUBUNGI_ADMIN.png" alt="Hubungi Admin" className="w-30 h-30" />
              </div>
              <div className="w-0.5 h-16 border-l-2 border-dotted border-white my-2"></div>
            ...
            <div className="flex flex-col items-center flex-1 relative z-10 max-w-48">
              <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative" style={{ minHeight: '7rem' }}>
                <span className="absolute -top-2 -left-2 w-8 h-8 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-lg border-2 border-[#778873] shadow">2</span>
            ...
            <div className="flex flex-col items-center flex-1 relative z-10 max-w-48">
              <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative" style={{ minHeight: '7rem' }}>
                <span className="absolute -top-2 -left-2 w-8 h-8 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-lg border-2 border-[#778873] shadow">3</span>
            ...
            <div className="flex flex-col items-center flex-1 relative z-10 max-w-48">
              <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative" style={{ minHeight: '7rem' }}>
                <span className="absolute -top-2 -left-2 w-8 h-8 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-lg border-2 border-[#778873] shadow">4</span>
            ...
            <div className="flex flex-col items-center flex-1 relative z-10 max-w-48">
              <div className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative" style={{ minHeight: '7rem' }}>
                <span className="absolute -top-2 -left-2 w-8 h-8 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-lg border-2 border-[#778873] shadow">5</span>
          ...
          <div className="lg:hidden space-y-8">
            ...
            <div className="flex items-start space-x-4 relative mt-8">
              <div className="flex-shrink-0 relative">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative">
                  <span className="absolute -top-2 -left-2 w-6 h-6 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-base">1</span>
                  <img src="/ICON_HUBUNGI_ADMIN.png" alt="Hubungi Admin" className="w-30 h-30" />
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-0 w-0.5 h-8 border-l-2 border-dotted border-white"></div>
              </div>
            ...
            <div className="flex items-start space-x-4 relative">
              <div className="flex-shrink-0 relative">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative">
                  <span className="absolute -top-2 -left-2 w-6 h-6 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-base">2</span>
                  <img src="/ICON_CONSULT.png" alt="Konsultasi" className="w-30 h-30" />
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-0 w-0.5 h-8 border-l-2 border-dotted border-white"></div>
              </div>
            ...
            <div className="flex items-start space-x-4 relative">
              <div className="flex-shrink-0 relative">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative">
                  <span className="absolute -top-2 -left-2 w-6 h-6 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-base">3</span>
                  <img src="/ICON_QUOTATION.png" alt="Quotation" className="w-30 h-30" />
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-0 w-0.5 h-8 border-l-2 border-dotted border-white"></div>
              </div>
            ...
            <div className="flex items-start space-x-4 relative">
              <div className="flex-shrink-0 relative">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative">
                  <span className="absolute -top-2 -left-2 w-6 h-6 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-base">4</span>
                  <img src="/ICON_SAMPLE.png" alt="Sample" className="w-30 h-30" />
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-0 w-0.5 h-8 border-l-2 border-dotted border-white"></div>
              </div>
            ...
            <div className="flex items-start space-x-4 relative">
              <div className="flex-shrink-0 relative">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 relative">
                  <span className="absolute -top-2 -left-2 w-6 h-6 bg-[#778873] text-white rounded-full flex items-center justify-center font-bold text-base">5</span>
                  <img src="/ICON_PRODUKSI.png" alt="Produksi" className="w-30 h-30" />
                </div>
              </div>
              <div className="flex-1 pt-2">
