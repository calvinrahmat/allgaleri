...
const socialMedia = [
  {
    ...
    url: "https://instagram.com/allgaleri",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@allgaleri?_t=ZS-8xF21OPHFth&_r=1",
    color: "bg-black",
...
const ecommerce = [
  {
    ...
    url: "https://tokopedia.com/allgaleri",
    color: "bg-green-600",
  ...
  },
  {
    ...
    url: "https://shopee.co.id/allgaleri",
    color: "bg-orange-600",
