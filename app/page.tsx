  ...
  return (
    <main className="min-h-screen bg-gray-100">
      ...
      <section className="relative w-full min-h-screen">
        ...
        {/* White overlay */}
        <div className="absolute inset-0 flex flex-col justify-start pt-32 md:pt-46 p-4 text-[#5453E3] z-20 items-center text-center md:items-start md:text-left max-w-xl md:max-w-2xl lg:max-w-3xl">
